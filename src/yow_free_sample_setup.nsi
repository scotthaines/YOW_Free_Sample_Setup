...
;       MessageBox MB_OK "Install 32 bit Git."
        ...
        SetRegView 32
        File ..\data\Git-2.8.1-32-bit.exe
        File ..\data\GitInf.txt
        ExecWait '"Git-2.8.1-32-bit.exe" /LOADINF=GitInf.txt' $0
        SetOutPath $dirDraft
;       Goto REG_READ_SUCCESS
...
;   MessageBox MB_OK "Install 64 bit Git."
    SetOutPath $PLUGINSDIR
    SetRegView 64
    File ..\data\Git-2.8.1-64-bit.exe
    File ..\data\GitInf.txt
    ExecWait '"Git-2.8.1-64-bit.exe" /LOADINF=GitInf.txt' $0
    SetOutPath $dirDraft
;   Goto REG_READ_SUCCESS
    StrCpy $GitInstallCheckAB "CheckB"  ; This indicates second check.
    Goto TRY_AGAIN
